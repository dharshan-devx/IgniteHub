...
const companyValues = [
  {
    ...
    description: 'We believe in the power of young minds to create groundbreaking solutions and change the world.'
  },
  {
    icon: <Target className="text-purple-500" size={32} />,
    title: 'Curated Quality',
    description: 'Every resource is carefully selected and vetted to ensure it provides real value to young innovators.'
  },
  {
    icon: <Users className="text-blue-500" size={32} />,
    title: 'Community Driven',
    description: 'Built by young innovators, for young innovators. We understand the challenges because we face them too.'
  },
  {
    icon: <Heart className="text-red-500" size={32} />,
    title: 'Accessible to All',
    description: 'Innovation should not be limited by resources. We prioritize free and accessible tools and opportunities.'
  }
];
